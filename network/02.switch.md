...
&emsp;&emsp;Address: 8 bits, 指定地址. 类型如下:
&emsp;&emsp;&emsp;&emsp;11111111 - all station address
&emsp;&emsp;&emsp;&emsp;00000000 - no station address
&emsp;&emsp;&emsp;&emsp;<others> - group address

&emsp;&emsp;Control: 8 bits

&emsp;&emsp;Protocol(ISO/IEC 13239:2002不包含该字段, Cisco特有): 16 bits, 上层协议类型. 常见类型列表:<br>
&emsp;&emsp;&emsp;&emsp;0x0800    IPv4<br>
&emsp;&emsp;&emsp;&emsp;0x8035    ARP<br>

&emsp;&emsp;Information Field: 8\*N bits, TCP/IP栈上层传下来的内容

&emsp;&emsp;FCS: 16 bits, 使用CRC进行校验
