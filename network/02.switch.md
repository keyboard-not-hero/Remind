...
[HW-ui-console0] set authentication password {simple | cipher} <passwd>
```
<br>
...
```
[HW] user-interface vty 0 4
[HW-ui-vty0-4] authentication-mode password
[HW-ui-vty0-4] set authentication password {simple | cipher} <passwd>
```
<br>
<br>
