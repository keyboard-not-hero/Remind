...
R4(config)# route-map AS65400 permit 20
R4(config)# router bgp 65100
...
R4# show bgp ipv4 unicast 192.168.10.0
BGP routing table entry for 192.168.10.0/24, version 15
...
R4# show bgp ipv4 unicast 192.168.10.0/24
BGP routing table entry for 192.168.10.0/24, version 18
Paths: (2 available, best #2, table default)
  Advertised to update-groups:
     1         
  Refresh Epoch 1
...
R4# show bgp ipv4 unicast 192.168.10.0/24
BGP routing table entry for 192.168.10.0/24, version 20
Paths: (2 available, best #1, table default)
  Advertised to update-groups:
     1         
  Refresh Epoch 2
