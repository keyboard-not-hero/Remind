...
BGP routing table entry for 192.168.10.0/24, version 16
...
R4# show bgp ipv4 unicast 192.168.10.0
BGP routing table entry for 192.168.10.0/24, version 26
...
BGP routing table entry for 10.10.30.0/24, version 8
Paths: (2 available, best #2, table default)
  Advertised to update-groups:
     1          2         
  Refresh Epoch 7
  ...
  Local
    0.0.0.0 from 0.0.0.0 (4.4.4.4)
      ...
      rx pathid: 0, tx pathid: 0x0    10.10.30.10 from 10.10.30.10 (10.10.10.10)
...
R4# show bgp ipv4 unicast 192.168.10.0
BGP routing table entry for 192.168.10.0/24, version 27
Paths: (2 available, best #2, table default)
  Advertised to update-groups:
     2         
  Refresh Epoch 4
