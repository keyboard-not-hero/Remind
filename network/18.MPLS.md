...
##### Route Distinguisher(RD)<br>
64 bits, 由于在iBGP peer之间, 不同VPN需要允许使用重叠的IP地址空间, 将RD添加到IPv4地址之前, 组成96 bits的VPNv4地址<br>
RD格式: AS:nn或IP-address:nn, nn由Service Provider提供. 建议使用AS:nn, IP-address适用于不同Service provider之间的连接<br>
每一个VRF使用不同的RD
<br>
<br>

##### 常用的两种BGP Extended Community<br>
1.Route Target<br>

2.Route Origin(参考示例15)
<br>
<br>
...
图16<br>
![image_not_found](pic/mpls_case_06.png)<br>
...
R1(config)# router ospf 1
R1(config-router)# network 192.168.1.1 0.0.0.0 area 0
R1(config-router)# network 10.10.15.0 0.0.0.255 area 0

R2(config)# router ospf 1
R2(config-router)# network 192.168.1.2 0.0.0.0 area 0
R2(config-router)# network 10.10.26.0 0.0.0.255 area 0

R3(config)# router ospf 1
R3(config-router)# network 192.168.1.3 0.0.0.0 area 0
R3(config-router)# network 10.10.37.0 0.0.0.255 area 0

R4(config)# router ospf 1
R4(config-router)# network 192.168.1.4 0.0.0.0 area 0
R4(config-router)# network 10.10.48.0 0.0.0.255 area 0
...
R7(config-router)# network 10.10.0.0 0.0.255.255 area 0

R8(config)# router ospf 1
R8(config-router)# network 192.168.1.8 0.0.0.0 area 0
R8(config-router)# network 10.10.0.0 0.0.255.255 area 0

R16(config)# router ospf 1
R16(config-router)# network 192.168.1.16 0.0.0.0 area 0
R16(config-router)# network 10.10.0.0 0.0.255.255 area 0

R17(config)# router ospf 1
R17(config-router)# network 192.168.1.17 0.0.0.0 area 0
R17(config-router)# network 10.10.0.0 0.0.255.255 area 0
...
R8(config)# router ospf 1
R8(config-router)# mpls ldp autoconfig

R16(config)# router ospf 1
R16(config-router)# mpls ldp autoconfig

R17(config)# router ospf 1
R17(config-router)# mpls ldp autoconfig



配置BGP
R1(config)# router bgp 65000
R1(config-router)# neighbor 192.168.1.16 remote-as 65000
R1(config-router)# neighbor 192.168.1.16 update-source loopback0
R1(config-router)# neighbor 192.168.1.17 remote-as 65000
R1(config-router)# neighbor 192.168.1.17 update-source loopback0
R1(config-router)# redistribute ospf 1
R1(config-router)# address-family vpnv4 
R1(config-router-af)# neighbor 192.168.1.16 activate
R1(config-router-af)# neighbor 192.168.1.16 send-community extended
R1(config-router-af)# neighbor 192.168.1.17 activate
R1(config-router-af)# neighbor 192.168.1.17 send-community extended

R2(config)# router bgp 65000
R2(config-router)# neighbor 192.168.1.16 remote-as 65000
R2(config-router)# neighbor 192.168.1.16 update-source loopback0
R2(config-router)# neighbor 192.168.1.17 remote-as 65000
R2(config-router)# neighbor 192.168.1.17 update-source loopback0
R2(config-router)# redistribute ospf 1
R2(config-router)# address-family vpnv4
R2(config-router-af)# neighbor 192.168.1.16 activate
R2(config-router-af)# neighbor 192.168.1.16 send-community extended
R2(config-router-af)# neighbor 192.168.1.17 activate
R2(config-router-af)# neighbor 192.168.1.17 send-community extended

R3(config)# router bgp 65000
R3(config-router)# neighbor 192.168.1.16 remote-as 65000
R3(config-router)# neighbor 192.168.1.16 update-source loopback0
R3(config-router)# neighbor 192.168.1.17 remote-as 65000
R3(config-router)# neighbor 192.168.1.17 update-source loopback0
R3(config-router)# redistribute ospf 1
R3(config-router)# address-family vpnv4
R3(config-router-af)# neighbor 192.168.1.16 activate
R3(config-router-af)# neighbor 192.168.1.16 send-community extended
R3(config-router-af)# neighbor 192.168.1.17 activate
R3(config-router-af)# neighbor 192.168.1.17 send-community extended

R4(config)# router bgp 65000
R4(config-router)# neighbor 192.168.1.16 remote-as 65000
R4(config-router)# neighbor 192.168.1.16 update-source loopback0
R4(config-router)# neighbor 192.168.1.17 remote-as 65000
R4(config-router)# neighbor 192.168.1.17 update-source loopback0
R4(config-router)# redistribute ospf 1
R4(config-router)# address-family vpnv4
R4(config-router-af)# neighbor 192.168.1.16 activate
R4(config-router-af)# neighbor 192.168.1.16 send-community extended
R4(config-router-af)# neighbor 192.168.1.17 activate
R4(config-router-af)# neighbor 192.168.1.17 send-community extended

R16(config)# router bgp 65000
R16(config-router)# neighbor 192.168.1.1 remote-as 65000
R16(config-router)# neighbor 192.168.1.1 update-source loopback0
R16(config-router)# neighbor 192.168.1.2 remote-as 65000
R16(config-router)# neighbor 192.168.1.2 update-source loopback0
R16(config-router)# neighbor 192.168.1.3 remote-as 65000
R16(config-router)# neighbor 192.168.1.3 update-source loopback0
R16(config-router)# neighbor 192.168.1.4 remote-as 65000
R16(config-router)# neighbor 192.168.1.4 update-source loopback0
R16(config-router)# redistribute ospf 1
R16(config-router)# address-family vpnv4
R16(config-router-af)# neighbor 192.168.1.1 activate
R16(config-router-af)# neighbor 192.168.1.1 send-community extended
R16(config-router-af)# neighbor 192.168.1.1 route-reflector-client
R16(config-router-af)# neighbor 192.168.1.2 activate 
R16(config-router-af)# neighbor 192.168.1.2 send-community extended
R16(config-router-af)# neighbor 192.168.1.2 route-reflector-client
R16(config-router-af)# neighbor 192.168.1.3 activate 
R16(config-router-af)# neighbor 192.168.1.3 send-community extended
R16(config-router-af)# neighbor 192.168.1.3 route-reflector-client
R16(config-router-af)# neighbor 192.168.1.4 activate 
R16(config-router-af)# neighbor 192.168.1.4 send-community extended
R16(config-router-af)# neighbor 192.168.1.4 route-reflector-client

R17(config)# router bgp 65000
R17(config-router)# neighbor 192.168.1.1 remote-as 65000
R17(config-router)# neighbor 192.168.1.1 update-source loopback0
R17(config-router)# neighbor 192.168.1.2 remote-as 65000
R17(config-router)# neighbor 192.168.1.2 update-source loopback0
R17(config-router)# neighbor 192.168.1.3 remote-as 65000
R17(config-router)# neighbor 192.168.1.3 update-source loopback0
R17(config-router)# neighbor 192.168.1.4 remote-as 65000
R17(config-router)# neighbor 192.168.1.4 update-source loopback0
R17(config-router)# redistribute ospf 1
R17(config-router)# address-family vpnv4
R17(config-router-af)# neighbor 192.168.1.1 activate
R17(config-router-af)# neighbor 192.168.1.1 send-community extended
R17(config-router-af)# neighbor 192.168.1.1 route-reflector-client
R17(config-router-af)# neighbor 192.168.1.2 activate 
R17(config-router-af)# neighbor 192.168.1.2 send-community extended
R17(config-router-af)# neighbor 192.168.1.2 route-reflector-client
R17(config-router-af)# neighbor 192.168.1.3 activate
R17(config-router-af)# neighbor 192.168.1.3 send-community extended
R17(config-router-af)# neighbor 192.168.1.3 route-reflector-client
R17(config-router-af)# neighbor 192.168.1.4 activate
R17(config-router-af)# neighbor 192.168.1.4 send-community extended
R17(config-router-af)# neighbor 192.168.1.4 route-reflector-client
...
R1(config-vrf)# ip vrf Company_B
R1(config-vrf)# rd 1:110
R1(config-vrf)# route-target both 100:110
R1(config-vrf)# ip vrf Company_C
R1(config-vrf)# rd 1:120
R1(config-vrf)# route-target both 100:120
R1(config-vrf)# int f0/0
R1(config-if)# ip vrf forwarding Company_A
R1(config-if)# ip add 172.16.10.1 255.255.255.0
...
R1(config-if)# int f1/0
R1(config-if)# ip vrf forwarding Company_C
R1(config-if)# ip add 172.16.30.1 255.255.255.0

R2(config)# ip vrf Company_A
R2(config-vrf)# rd 1:100
R2(config-vrf)# route-target both 100:100
R2(config-vrf)# ip vrf Company_B
R2(config-vrf)# rd 1:110
R2(config-vrf)# route-target both 100:110
R2(config-vrf)# int f0/0
R2(config-if)# ip vrf forwarding Company_A
R2(config-if)# ip add 172.16.40.2 255.255.255.0
R2(config-if)# int f0/1
R2(config-if)# ip vrf forwarding Company_B
R2(config-if)# ip add 172.16.50.2 255.255.255.0

R3(config)# ip vrf Company_C
R3(config-vrf)# rd 1:120
R3(config-vrf)# route-target both 100:120
R3(config-vrf)# int f0/0
R3(config-if)# ip vrf forwarding Company_C
R3(config-if)# ip add 172.16.60.3 255.255.255.0

R4(config)# ip vrf Company_C
R4(config-vrf)# rd 1:120
R4(config-vrf)# route-target 100:120
R4(config-vrf)# int f0/0
R4(config-if)# ip vrf forwarding Company_C
R4(config-if)# ip add 172.16.70.4 255.255.255.0
...
R1(config)# router bgp 65000
R1(config-router)# address-family ipv4 vrf Company_A
R1(config-router-af)# neighbor 172.16.10.9 remote-as 64500
R1(config-router-af)# neighbor 172.16.10.9 activate
R1(config-router-af)# address-family ipv4 vrf Company_B
R1(config-router-af)# neighbor 172.16.20.10 remote-as 64600
R1(config-router-af)# neighbor 172.16.20.10 activate
R1(config-router-af)# address-family ipv4 vrf Company_C
R1(config-router-af)# neighbor 172.16.30.11 remote-as 64700
R1(config-router-af)# neighbor 172.16.30.11 activate

R9(config)# router bgp 64500
R9(config-router)# neighbor 172.16.10.1 remote-as 65000
R9(config-router)# redistribute connected

R10(config)# router bgp 64600
R10(config-router)# neighbor 172.16.20.1 remote-as 65000
R10(config-router)# redistribute connected 

R11(config)# router bgp 64700
R11(config-router)# neighbor 172.16.30.1 remote-as 65000
R11(config-router)# redistribute connected

R2(config)# router bgp 65000
R2(config-router)# address-family ipv4 vrf Company_A
R2(config-router-af)# neighbor 172.16.40.12 remote-as 64800
R2(config-router-af)# neighbor 172.16.40.12 activate
R2(config-router-af)# address-family ipv4 vrf Company_B
R2(config-router-af)# neighbor 172.16.50.13 remote-as 64900
R2(config-router-af)# neighbor 172.16.50.13 activate

R12(config)# router bgp 64800
R12(config-router)# neighbor 172.16.40.2 remote-as 65000
R12(config-router)# redistribute connected

R13(config)# router bgp 64900
R13(config-router)# neighbor 172.16.50.2 remote-as 65000
R13(config-router)# redistribute connected

R3(config)# router bgp 65000
R3(config-router)# address-family ipv4 vrf Company_C
R3(config-router-af)# neighbor 172.16.60.14 remote-as 65100
R3(config-router-af)# neighbor 172.16.60.14 activate

R14(config)# router bgp 65100
R14(config-router)# neighbor 172.16.60.3 remote-as 65000
R14(config-router)# redistribute connected

R4(config)# router bgp 65000
R4(config-router)# address-family ipv4 vrf Company_C
R4(config-router-af)# neighbor 172.16.70.15 remote-as 65200
R4(config-router-af)# neighbor 172.16.70.15 activate

R15(config)# router bgp 65200
R15(config-router)# neighbor 172.16.70.4 remote-as 65000
R15(config-router)# redistribute connected



使用route reflector作为full mesh的替代方案, 可减少iBGP peer数量
此时, R16/R17接收的NLRI
R16# show bgp vpnv4 unicast all neighbor 192.168.1.1 route | begin Network
     Network          Next Hop            Metric LocPrf Weight Path
Route Distinguisher: 1:100
 *>i 172.16.10.0/24   192.168.1.1              0    100      0 64500 ?
 *>i 192.168.1.9/32   192.168.1.1              0    100      0 64500 ?
Route Distinguisher: 1:110
 *>i 172.16.20.0/24   192.168.1.1              0    100      0 64600 ?
 *>i 192.168.1.10/32  192.168.1.1              0    100      0 64600 ?
Route Distinguisher: 1:120
 *>i 172.16.30.0/24   192.168.1.1              0    100      0 64700 ?
 *>i 192.168.1.11/32  192.168.1.1              0    100      0 64700 ?

Total number of prefixes 6


R16# show bgp vpnv4 unicast all neighbor 192.168.1.2 route | begin Network
     Network          Next Hop            Metric LocPrf Weight Path
Route Distinguisher: 1:100
 *>i 172.16.40.0/24   192.168.1.2              0    100      0 64800 ?
 *>i 192.168.1.12/32  192.168.1.2              0    100      0 64800 ?
Route Distinguisher: 1:110
 *>i 172.16.50.0/24   192.168.1.2              0    100      0 64900 ?
 *>i 192.168.1.13/32  192.168.1.2              0    100      0 64900 ?

Total number of prefixes 4


R16# show bgp vpnv4 unicast all neighbor 192.168.1.3 route | begin Network
     Network          Next Hop            Metric LocPrf Weight Path
Route Distinguisher: 1:120
 *>i 172.16.60.0/24   192.168.1.3              0    100      0 65100 ?
 *>i 192.168.1.14/32  192.168.1.3              0    100      0 65100 ?

Total number of prefixes 2 


R16# show bgp vpnv4 unicast all neighbor 192.168.1.4 route | begin Network
     Network          Next Hop            Metric LocPrf Weight Path
Route Distinguisher: 1:120
 *>i 172.16.70.0/24   192.168.1.4              0    100      0 65200 ?
 *>i 192.168.1.15/32  192.168.1.4              0    100      0 65200 ?

Total number of prefixes 2 



R17# show bgp vpnv4 unicast all neighbor 192.168.1.1 route | begin Network
     Network          Next Hop            Metric LocPrf Weight Path
Route Distinguisher: 1:100
 *>i 172.16.10.0/24   192.168.1.1              0    100      0 64500 ?
 *>i 192.168.1.9/32   192.168.1.1              0    100      0 64500 ?
...
R17# show bgp vpnv4 unicast all neighbor 192.168.1.2 route | begin Network
     Network          Next Hop            Metric LocPrf Weight Path
Route Distinguisher: 1:100
 *>i 172.16.40.0/24   192.168.1.2              0    100      0 64800 ?
 *>i 192.168.1.12/32  192.168.1.2              0    100      0 64800 ?
...
R17# show bgp vpnv4 unicast all neighbor 192.168.1.3 route | begin Network
     Network          Next Hop            Metric LocPrf Weight Path
Route Distinguisher: 1:120
 *>i 172.16.60.0/24   192.168.1.3              0    100      0 65100 ?
 *>i 192.168.1.14/32  192.168.1.3              0    100      0 65100 ?
...
R17# show bgp vpnv4 unicast all neighbor 192.168.1.4 route | begin Network
     Network          Next Hop            Metric LocPrf Weight Path
Route Distinguisher: 1:120
 *>i 172.16.70.0/24   192.168.1.4              0    100      0 65200 ?
 *>i 192.168.1.15/32  192.168.1.4              0    100      0 65200 ?
...
为了提升route reflector在高吞吐量Backbone区域的可用性, 使用rr-group过滤入项route target
R16(config)# ip extcommunity standard RANGE permit rt 100:100
R16(config)# ip extcommunity standard RANGE permit rt 100:110
R16(config)# do show ip extcommunity
Standard extended community-list RANGE
     10 permit RT:100:100
     20 permit RT:100:110
R16(config)# router bgp 6500
BGP is already running; AS is 65000
R16(config)# router bgp 65000
R16(config-router)# address-family vpnv4
R16(config-router-af)# bgp rr-group RANGE

R17(config)# ip extcommunity standard RANGE permit rt 100:120
R17(config)# router bgp 65000
R17(config-router)# address-family vpnv4
R17(config-router-af)# bgp rr-group RANGE
...
[5] BGP/MPLS IP Virtual Private Networks (VPNs): https://datatracker.ietf.org/doc/html/rfc4364
