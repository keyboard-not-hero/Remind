...
$\mathrm{Disable}\xrightarrow{\makebox[3cm]{Max age(20s)}}\mathrm{Blocking}\xrightarrow{\makebox[3cm]{}}\mathrm{Listening}\xrightarrow{\makebox[3cm]{Forward delay(15s)}}\mathrm{Learning}\xrightarrow{\makebox[3cm]{Forward delay(15s)}}\mathrm{Forwarding}$
<br>
<br>
<br>
