...
$\mathrm{Disable}\xrightarrow{\mathrm{Max\ age(20s)}}\mathrm{Blocking}\xrightarrow{}\mathrm{Listening}\xrightarrow{\mathrm{Forward\ delay(15s)}}\mathrm{Learning}\xrightarrow{\mathrm{Forward\ delay(15s)}}\mathrm{Forwarding}$
<br>
<br>
<br>
