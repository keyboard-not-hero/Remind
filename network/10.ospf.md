...
2.administration distance(Cisco)/Preference(Huawei)<br>
Cisco AD:
|路由类型                |AD值                    |
|------------------------|------------------------|
|connected               |0                       |
...
|State|Description|
|---|---|
|Down|路由器还没有收到OSPF hello包|
|Attemp|用于nonbroadcast multi-access(NBMA)网络|
|Init|收到其他路由器发送的hello包, 但是包内不包含接收者路由器的Router ID|
|2-Way|收到其他路由器发送的hello包, 并且包内包含接收者路由器的Router ID|
|Exstart|收到标识谁是master/slave的DB Description|
|Exchange|在DB Description中交换LSA摘要信息|
|Loading|当前路由器第一次发送LS Request|
|Full|邻接路由器创建完整邻接关系|

图1<br>
![image_not_found](pic/ospf_neighbor.png)
<br>

图2<br>
![image_not_found](pic/ospf_neighbor_example.png)
...
R2(config-if)# no shutdown
R2(config-if)# exit
R2(config)# clock time CST 8
R2(config)# ntp server 203.107.6.88
R2(config)# ntp master 3
R2(config)# logging monitor 7

R1(config)# int f0/0
R1(configi-if)# ip add 192.168.10.1 255.255.255.0
R1(config-if)# no shutdown
R1(config-if)# exit
R1(config)# clock time CST 8
...
R1
1.
May 22 12:32:19.314: OSPF-1 HELLO Fa0/0: Send hello to 224.0.0.5 area 0 from 192.168.10.1


2.
May 22 12:32:19.330: OSPF-1 HELLO Fa0/0: Rcv hello from 2.2.2.2 area 0 192.168.10.2
May 22 12:32:19.334: OSPF-1 ADJ   Fa0/0: 2 Way Communication to 2.2.2.2, state 2WAY


3.
May 22 12:32:19.334: OSPF-1 HELLO Fa0/0: Send immediate hello to nbr 2.2.2.2, src address 192.168.10.2
May 22 12:32:19.334: OSPF-1 HELLO Fa0/0: Send hello to 192.168.10.2 area 0 from 192.168.10.1


4.
May 22 12:32:49.859: OSPF-1 ADJ   Fa0/0: Rcv DBD from 2.2.2.2 seq 0x1A3E opt 0x52 flag 0x7 len 32  mtu 1500 state 2WAY


5.
May 22 12:32:59.311: OSPF-1 ADJ   Fa0/0: end of Wait on interface
May 22 12:32:59.311: OSPF-1 ADJ   Fa0/0: DR/BDR election
May 22 12:32:59.311: OSPF-1 ADJ   Fa0/0: Elect BDR 1.1.1.1
May 22 12:32:59.315: OSPF-1 ADJ   Fa0/0: Elect DR 2.2.2.2
May 22 12:32:59.315: OSPF-1 ADJ   Fa0/0: Elect BDR 1.1.1.1
May 22 12:32:59.315: OSPF-1 ADJ   Fa0/0: Elect DR 2.2.2.2
May 22 12:32:59.315: OSPF-1 ADJ   Fa0/0: DR: 2.2.2.2 (Id)   BDR: 1.1.1.1 (Id)
May 22 12:32:59.319: OSPF-1 ADJ   Fa0/0: Nbr 2.2.2.2: Prepare dbase exchange
May 22 12:32:59.319: OSPF-1 ADJ   Fa0/0: Send DBD to 2.2.2.2 seq 0x708 opt 0x52 flag 0x7 len 32


6.
May 22 12:32:59.491: OSPF-1 ADJ   Fa0/0: Rcv DBD from 2.2.2.2 seq 0x1A3E opt 0x52 flag 0x7 len 32  mtu 1500 state EXSTART


7.
May 22 12:32:59.499: OSPF-1 ADJ   Fa0/0: Send DBD to 2.2.2.2 seq 0x1A3E opt 0x52 flag 0x2 len 52


8.
May 22 12:32:59.511: OSPF-1 ADJ   Fa0/0: Rcv DBD from 2.2.2.2 seq 0x1A3F opt 0x52 flag 0x1 len 52  mtu 1500 state EXCHANGE


9.
May 22 12:32:59.511: OSPF-1 ADJ   Fa0/0: Send DBD to 2.2.2.2 seq 0x1A3F opt 0x52 flag 0x0 len 32


10.
May 22 12:32:59.511: OSPF-1 ADJ   Fa0/0: Send LS REQ to 2.2.2.2 length 36 LSA count 1


11.
May 22 12:32:59.519: OSPF-1 ADJ   Fa0/0: Rcv LS UPD from 2.2.2.2 length 64 LSA count 1
May 22 12:32:59.519: OSPF-1 ADJ   Fa0/0: Synchronized with 2.2.2.2, state FULL
May 22 12:32:59.519: %OSPF-5-ADJCHG: Process 1, Nbr 2.2.2.2 on FastEthernet0/0 from LOADING to FULL, Loading Done


12.
May 22 12:32:59.523: OSPF-1 ADJ   Fa0/0: Rcv LS REQ from 2.2.2.2 length 36 LSA count 1


13.
May 22 12:32:59.568: OSPF-1 ADJ   Fa0/0: Send LS UPD to 2.2.2.2 length 64 LSA count 1



R2
1.
May 22 12:32:19.344: OSPF-1 HELLO Fa0/0: Rcv hello from 1.1.1.1 area 0 192.168.10.1


2.
May 22 12:32:19.344: OSPF-1 HELLO Fa0/0: Send immediate hello to nbr 1.1.1.1, src address 192.168.10.1
May 22 12:32:19.344: OSPF-1 HELLO Fa0/0: Send hello to 192.168.10.1 area 0 from 192.168.10.2


3.
May 22 12:32:19.376: OSPF-1 HELLO Fa0/0: Rcv hello from 1.1.1.1 area 0 192.168.10.1
May 22 12:32:19.380: OSPF-1 ADJ   Fa0/0: 2 Way Communication to 1.1.1.1, state 2WAY


4.
May 22 12:32:49.877: OSPF-1 ADJ   Fa0/0: end of Wait on interface
May 22 12:32:49.877: OSPF-1 ADJ   Fa0/0: DR/BDR election
May 22 12:32:49.877: OSPF-1 ADJ   Fa0/0: Elect BDR 2.2.2.2
May 22 12:32:49.881: OSPF-1 ADJ   Fa0/0: Elect DR 2.2.2.2
May 22 12:32:49.881: OSPF-1 ADJ   Fa0/0: Elect BDR 1.1.1.1
May 22 12:32:49.881: OSPF-1 ADJ   Fa0/0: Elect DR 2.2.2.2
May 22 12:32:49.881: OSPF-1 ADJ   Fa0/0: DR: 2.2.2.2 (Id)   BDR: 1.1.1.1 (Id)
May 22 12:32:49.885: OSPF-1 ADJ   Fa0/0: Nbr 1.1.1.1: Prepare dbase exchange
May 22 12:32:49.885: OSPF-1 ADJ   Fa0/0: Send DBD to 1.1.1.1 seq 0x1A3E opt 0x52 flag 0x7 len 32


5.
May 22 12:32:59.377: OSPF-1 ADJ   Fa0/0: Rcv DBD from 1.1.1.1 seq 0x708 opt 0x52 flag 0x7 len 32  mtu 1500 state EXSTART


6.
May 22 12:32:59.513: OSPF-1 ADJ   Fa0/0: Send DBD to 1.1.1.1 seq 0x1A3E opt 0x52 flag 0x7 len 32


7.
May 22 12:32:59.537: OSPF-1 ADJ   Fa0/0: Rcv DBD from 1.1.1.1 seq 0x1A3E opt 0x52 flag 0x2 len 52  mtu 1500 state EXSTART


8.
May 22 12:32:59.541: OSPF-1 ADJ   Fa0/0: Send DBD to 1.1.1.1 seq 0x1A3F opt 0x52 flag 0x1 len 52


9.
May 22 12:32:59.549: OSPF-1 ADJ   Fa0/0: Rcv DBD from 1.1.1.1 seq 0x1A3F opt 0x52 flag 0x0 len 32  mtu 1500 state EXCHANGE


10.
May 22 12:32:59.549: OSPF-1 ADJ   Fa0/0: Rcv LS REQ from 1.1.1.1 length 36 LSA count 1


11.
May 22 12:32:59.549: OSPF-1 ADJ   Fa0/0: Send LS UPD to 192.168.10.1 length 64 LSA count 1


12.
May 22 12:32:59.549: OSPF-1 ADJ   Fa0/0: Send LS REQ to 1.1.1.1 length 36 LSA count 1


13.
May 22 12:32:59.557: OSPF-1 ADJ   Fa0/0: Rcv LS UPD from 1.1.1.1 length 64 LSA count 1
May 22 12:32:59.557: OSPF-1 ADJ   Fa0/0: Synchronized with 1.1.1.1, state FULL
May 22 12:32:59.557: %OSPF-5-ADJCHG: Process 1, Nbr 1.1.1.1 on FastEthernet0/0 from LOADING to FULL, Loading Done
```
<br>
<br>
...
###### Huawei版本配置
1.配置ospf<br>
`[R1] ospf [<process_id>] [router-id <router_id>]`
<br>
<br>

2.进入指定area<br>
`[R1-ospf-1] area <area_id>`
<br>
<br>

3.将接口配置到OSPF<br>
1)network模式<br>
`[R1-ospf-1-area-0.0.0.0] network <network> <wildcard_mask>`

2)接口模式<br
`[R1-GigabitEthernet0/0/1] ospf enable <process_id> area <area_id>`
<br>
<br>

4.接口优先级配置<br>
`[R1-GigabitEthernet0/0/1] ospf dr-priority <priority>`
<br>
<br>

5.Hello Timer配置<br>
`[R1-GigabitEthernet0/0/1] ospf timer hello <interval>`
<br>
<br>

6.Dead Timer配置<br>
`[R1-GigabitEthernet0/0/1] ospf timer dead <interval>`
<br>
<br>
<br>
...
如图10, Area 1和左侧Area 0的路由, 无法传播进右侧Area 0<br>
