...
系数:<br>
默认情况下<br>
$$K_1=1, K_2=0, K_3=1, K_4=0, K_5=0, K_6=0$$<br>
此时, metric公式简化为:<br>
$$Metric=65536\times(\frac{K_1\times 10^7}{Bandwidth_{min}}+\frac{K_3\times Total_{delay}}{10^6})$$<br>
** 当$K_5=0$时, 忽略以下部分:<br>
...
结果分析:<br>
R1到10.2.10.0/24子网的metric:<br>
$$metric=65536\times[1\times\frac{10^7}{10^5}+\frac{1\times 10^8}{10^6}]=256\times(100+100)=13107200$$<br>
R2到10.2.10.0/24子网的metric:<br>
$$metric=65536\times[1\times\frac{10^7}{10^4}+\frac{1\times(10^8+10^9)}{10^6}]=256\times(1000+1100)=137625600$$<br>
R3到10.2.10.0/24子网的metric:<br>
$$metric=256\times[1\times\frac{10^7}{10^4}+\frac{1\times(10^8+10^9+10^8)}{10^6}]=256\times(1000+1200)=144179200$$
<br>
<br>
