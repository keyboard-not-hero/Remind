...
结果分析:<br>
R1到10.2.10.0/24子网的metric:<br>
$$metric=65536\times[1\times\frac{10^7}{10^5}+\frac{1\times 10^8}{10^6}]=256\times(100+100)=13107200$$
R2到10.2.10.0/24子网的metric:<br>
$$metric=65536\times[1\times\frac{10^7}{10^4}+\frac{1\times(10^8+10^9)}{10^6}]=256\times(1000+1100)=137625600$$
R3到10.2.10.0/24子网的metric:<br>
...
EIGRP允许多个相同metric的路由, 加入路由表. 该值默认为4个, 允许配置数量[1,16]<br>
