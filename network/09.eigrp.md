...
计算公式如下
$$
Metric=256*[(\frac{K_1*10^7}{Bandwidth_{min}}+\frac{K_2*\frac{10^7}{Bandwidth_{min}}}{256-Load}+\frac{K_3*Total_{delay}}{10})*\frac{K_5}{K_4+Reliability}]
$$
<br>
...
此时, metric公式简化为:
$$
Metric=256*(\frac{K_1*10^7}{Bandwidth_{min}}+\frac{K_3*Total_{delay}}{10})
$$
** 当$K_5=0$时, 忽略以下部分:
$$
...
```
结果分析:<br>
R1到10.2.10.0/24子网的metric:
$$
metric=256*[1*\frac{10^7}{10^5}+\frac{1*100}{10}]=256*(100+10)=28160
$$
R2到10.2.10.0/24子网的metric:
$$
metric=256*[1*\frac{10^7}{10^4}+\frac{1*(100+1000)}{10}]=256*(1000+110)=284160
$$
R3到10.2.10.0/24子网的metric:
$$
metric=256*[1*\frac{10^7}{10^4}+\frac{1*(100+1000+100)}{10}]=256*(1000+120)=286720
$$
<br>
<br>
