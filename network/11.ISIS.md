...
图5<br>
![image_not_found](pic/isis_03.png)<br>

示例6(如图5)
```
R1(config)# ipv6 unicast-routing
R1(config)# router isis
R1(config-router)# net 0a.ca01.1a4d.0008.00
R1(config-router)# is-type level-1
R1(config-router)# int f0/0
R1(config-if)# ip router isis
R1(config-if)# ipv6 router isis
...
R2(config)# ipv6 unicast-routing
R2(config)# router isis
R2(config-router)# net 0a.ca02.1a6b.0008.00
R2(config-router)# is-type level-1
R2(config-router)# int f0/0
R2(config-if)# ip router isis
R2(config-if)# ipv6 router isis
...
R3(config)# ipv6 unicast-routing
R3(config)# router isis
R3(config-router)# net 0a.ca03.1a8a.0008.00
R3(config-router)# int f0/0
R3(config-if)# ip router isis
R3(config-if)# ipv6 router isis
R3(config-if)# int f0/1
...
R4(config)# ipv6 unicast-routing
R4(config)# router isis
R4(config-router)# net 14.ca04.1aa9.0008.00
R4(config-router)# int f0/0
R4(config-if)# ip router isis
R4(config-if)# ipv6 router isis
R4(config-if)# int f0/1
...
R5(config)# ipv6 unicast-routing
R5(config)# router isis
R5(config-router)# net 14.ca05.1ac7.0008.00
R5(config-router)# int f0/0
R5(config-if)# ip router isis
R5(config-if)# ipv6 router isis
R5(config-if)# int f0/1
...
R6(config)# ipv6 unicast-routing
R6(config)# router isis
R6(config-router)# net 14.ca06.1ae5.0008.00
R6(config-router)# is-type level-1
R6(config-router)# int f0/0
R6(config-if)# ip router isis
R6(config-if)# ipv6 router isis
...
R7(config)# ipv6 unicast-routing
R7(config)# router isis
R7(config-router)# net 1e.ca07.1b18.0008.00
R7(config-router)# int f0/0
R7(config-if)# ip router isis
R7(config-if)# ipv6 router isis
R7(config-if)# int f0/1
...
R8(config)# ipv6 unicast-routing
R8(config)# router isis
R8(config-router)# net 1e.ca08.1b3f.0008.00
R8(config-router)# is-type level-1
R8(config-router)# int f0/0
R8(config-if)# ip router isis
R8(config-if)# ipv6 router isis
...
R3# show isis ip topology  

IS-IS TID 0 paths to level-1 routers
System Id            Metric     Next-Hop             Interface   SNPA
R1                   10         R1                   Fa0/0       ca01.1a4d.0006 
R2                   10         R2                   Fa0/1       ca02.1a6b.0006 
R3                   --

IS-IS TID 0 paths to level-2 routers
System Id            Metric     Next-Hop             Interface   SNPA
R3                   --
R4                   10         R4                   Fa1/0       ca04.1aa9.0008 
R5                   20         R4                   Fa1/0       ca04.1aa9.0008 
R7                   30         R4                   Fa1/0       ca04.1aa9.0008



将R7的F0/0接口取消IPv6 ISIS配置
R7(config)# int f0/0
R7(config-if)# no ipv6 router isis
...
*Apr 27 03:53:30.199: ISIS-Adj: Rec L2 IIH from ca07.1b18.0008 (FastEthernet1/0), cir type L1L2, cir id CA07.1B18.0008.01, length 1497, ht(30)
*Apr 27 03:53:30.203: ISIS-Adj: No usable IPv6 linklocal addresses in LAN IIH from FastEthernet1/0


综上结论:
IPv6与IPv4默认共用一个Topology



IPv6配置与IPv4不同Topology
R1(config)# router isis
...
R2(config)# router isis
R2(config-router)# metric-style wide transition
R2(config-router)# address-family ipv6
R2(config-router-af)# multi-topology transition

R3(config)# router isis             
R3(config-router)# metric-style wide transition
R3(config-router)# address-family ipv6
R3(config-router-af)# multi-topology transition

R4(config)# router isis
R4(config-router)# metric-style wide transition
R4(config-router)# address-family ipv6
R4(config-router-af)# multi-topology transition

R5(config)# router isis
R5(config-router)# metric-style wide transition
R5(config-router)# address-family ipv6
R5(config-router-af)# multi-topology transition

R6(config)# router isis
R6(config-router)# metric-style wide transition
R6(config-router)# address-family ipv6
R6(config-router-af)# multi-topology transition

R7(config)# router isis
R7(config-router)# metric-style wide transition
R7(config-router)# address-family ipv6
R7(config-router-af)# multi-topology transition

R8(config)# router isis
R8(config-router)# metric-style wide transition      
R8(config-router)# address-family ipv6
R8(config-router-af)# multi-topology transition
...
##### 6.Route Leaking(路由泄露)
将L2的路由distribute给L1路由器, 从而在跨Area选择最佳path<br>

图6<br>
![image_not_found](pic/isis_04.png)<br>

示例7(如图6)
```
R1(config)# router isis
R1(config-router)# net 01.ca01.0e7f.0008.00
R1(config-router)# int f0/0
R1(config-if)# ip router isis
R1(config-if)# int f0/1
R1(config-if)# ip router isis
...
R2(config)# router isis
R2(config-router)# net 01.ca02.0ede.0008.00
R2(config-router)# int f0/0
R2(config-if)# ip router isis
R2(config-if)# int f0/1
R2(config-if)# ip router isis
...
R3(config)# router isis
R3(config-router)# net 02.ca03.0efd.0008.00
R3(config-router)# int f0/0
R3(config-if)# ip router isis
R3(config-if)# int f0/1
R3(config-if)# ip router isis
...
R4(config)# router isis
R4(config-router)# net 02.ca04.0f20.0008.00
R4(config-router)# int f0/0
R4(config-if)# ip router isis
R4(config-if)# int f0/1
R4(config-if)# ip router isis
...
R5(config)# router isis
R5(config-router)# net 02.ca05.0f3e.0008.00
...
R6(config)# router isis
R6(config-router)# net 02.ca06.0f5c.0008.00
R6(config-router)# is-type level-1
R6(config-router)# int f0/0
R6(config-if)# ip router isis
R6(config-if)# int f0/1
...
R7(config)# router isis
R7(config-router)# net 02.ca07.0f7a.0008.00
...
R8(config)# router isis
R8(config-router)# net 01.ca08.10a3.0008.00
R8(config-router)# is-type level-1
R8(config-router)# int f0/0
R8(config-if)# ip router isis
...
R9(config-router)# net 01.ca09.10c1.0008.00
R9(config-router)# is-type level-1
...
i*L1  0.0.0.0/0 [115/10] via 172.16.70.1, 00:05:20, FastEthernet0/0
      172.16.0.0/16 is variably subnetted, 7 subnets, 2 masks
i L1     172.16.10.0/24 [115/20] via 172.16.70.1, 00:05:30, FastEthernet0/0
i L1     172.16.20.0/24 [115/30] via 172.16.90.9, 00:05:20, FastEthernet0/1
C        172.16.70.0/24 is directly connected, FastEthernet0/0
L        172.16.70.8/32 is directly connected, FastEthernet0/0
i L1     172.16.80.0/24 [115/20] via 172.16.90.9, 00:05:20, FastEthernet0/1
C        172.16.90.0/24 is directly connected, FastEthernet0/1
L        172.16.90.8/32 is directly connected, FastEthernet0/1



R8# ping      
Protocol [ip]: 
Target IP address: 172.16.40.4
Repeat count [5]: 2
Datagram size [100]: 
...
Sending 2, 100-byte ICMP Echos to 172.16.40.4, timeout is 2 seconds:
...
Success rate is 100 percent (2/2), round-trip min/avg/max = 48/56/64 ms



配置route leak
R1(config)# access-list 100 permit ip 172.16.40.0 0.0.0.255 any
R1(config)# router isis
R1(config-router)# redistribute isis ip level-2 into level-1 distribute-list 100

R2(config)# access-list 100 permit ip 172.16.40.0 0.0.0.255 any
R2(config)# router isis
...
i*L1  0.0.0.0/0 [115/10] via 172.16.70.1, 00:11:25, FastEthernet0/0
      172.16.0.0/16 is variably subnetted, 8 subnets, 2 masks
i L1     172.16.10.0/24 [115/20] via 172.16.70.1, 00:11:35, FastEthernet0/0
i L1     172.16.20.0/24 [115/30] via 172.16.90.9, 00:11:25, FastEthernet0/1
i ia     172.16.40.0/24 [115/168] via 172.16.90.9, 00:00:36, FastEthernet0/1
C        172.16.70.0/24 is directly connected, FastEthernet0/0
L        172.16.70.8/32 is directly connected, FastEthernet0/0
i L1     172.16.80.0/24 [115/20] via 172.16.90.9, 00:11:25, FastEthernet0/1
C        172.16.90.0/24 is directly connected, FastEthernet0/1
L        172.16.90.8/32 is directly connected, FastEthernet0/1
...
Success rate is 100 percent (2/2), round-trip min/avg/max = 52/58/64 ms
```
<br>
<br>
