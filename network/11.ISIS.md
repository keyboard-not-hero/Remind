...
R4(config-router)# authentication key-chain CHAIN level-1

R5(config)# key chain CHAIN 
...
R5(config-router)# authentication key-chain CHAIN level-1
...
R6(config-router)# authentication key-chain CHAIN level-1



R3/R4/R5/R7 L2使用domain级配置, 并且配置md5
R3(config)# key chain CHAIN
...
R3(config-router)# authentication key-chain CHAIN level-2
...
R4(config-router)# authentication key-chain CHAIN level-2
...
R5(config-router)# authentication key-chain CHAIN level-2

R7(config)# key chain CHAIN
...
R7(config-router)# authentication key-chain CHAIN level-2
```
<br>
<br>
