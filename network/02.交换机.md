...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.通过frame的源mac地址进行学习<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.通过frame的目标mac地址确定转发接口<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.使用STP创建无循环的链路<br>
<br>
<br>
<br>
...
Type: 2 bytes, 数值=<1500时, 代表负载内容的长度; 数值>=1536时, 用于标记data在TCP/IP协议栈第三层协议的封装类型. 常见类型列表:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0x0800    IPv4<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0x0806    ARP<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0x86DD    IPv6<br>
...
Protocol: 2 bytes, 上层协议类型. 常见类型列表:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0x0800    IPv4<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0x8035    ARP<br>
...
给通过telnet/AUX/console连接的人显示消息<br>
...
实例6 - 设置IP地址
** 交换机使用SVI(switch virtual interface)接口进行IP流量管理
