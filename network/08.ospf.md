...
图13<br>
![image_not_found](pic/ospf_route_filter.png)<br>
<br>
...
prefix-list内容参考:<br>
12.condition_match.md的prefix-list部分<br>
<br>
...
图14<br>
![image_not_found](pic/ospf_distribute_list.png)<br>

3.不将Type 1 LSA或Type 3 LSA安装到本机路由表(RIB), 并且不影响在路由器间的传播(流程参考图14, 配置参考图12)<br>
配置语法
```
(config-router)# distribute-list {<acl_number> | <acl_name> | prefix <prefix_list_name> | route-map <route_map_name>} in
```

示例1 - 配置R4不安装10.1.3.0/24到RIB(LSA Type 1)<br>
```
配置前:
...
O        10.1.3.0/24 [110/2] via 10.1.2.5, 00:00:46, FastEthernet0/1
                     [110/2] via 10.1.1.6, 00:00:46, FastEthernet1/0
O        10.2.1.0/24 [110/2] via 10.2.4.2, 00:00:46, FastEthernet0/0
O        10.2.2.0/24 [110/3] via 10.2.4.2, 00:00:46, FastEthernet0/0
...
O IA     10.3.1.0/24 [110/2] via 10.1.1.6, 00:00:46, FastEthernet1/0
O IA     10.3.2.0/24 [110/2] via 10.1.1.6, 00:00:46, FastEthernet1/0
O IA     10.3.3.0/24 [110/3] via 10.1.1.6, 00:00:46, FastEthernet1/0



配置后:
R4(config)# ip prefix-list RIB_FILTER seq 5 deny 10.1.3.0/24
...
C        10.1.2.0/24 is directly connected, FastEthernet0/1
L        10.1.2.4/32 is directly connected, FastEthernet0/1
O        10.2.1.0/24 [110/2] via 10.2.4.2, 00:00:19, FastEthernet0/0
O        10.2.2.0/24 [110/3] via 10.2.4.2, 00:00:19, FastEthernet0/0
C        10.2.3.0/24 is directly connected, Serial4/0
L        10.2.3.4/32 is directly connected, Serial4/0
C        10.2.4.0/24 is directly connected, FastEthernet0/0
L        10.2.4.4/32 is directly connected, FastEthernet0/0
O IA     10.3.1.0/24 [110/2] via 10.1.1.6, 00:00:19, FastEthernet1/0
O IA     10.3.2.0/24 [110/2] via 10.1.1.6, 00:00:19, FastEthernet1/0
O IA     10.3.3.0/24 [110/3] via 10.1.1.6, 00:00:19, FastEthernet1/0

R2# show ip route | begin Gateway
Gateway of last resort is not set

      10.0.0.0/8 is variably subnetted, 12 subnets, 2 masks
O IA     10.1.1.0/24 [110/2] via 10.2.4.4, 01:25:44, FastEthernet0/1
O IA     10.1.2.0/24 [110/2] via 10.2.4.4, 01:25:44, FastEthernet0/1
O IA     10.1.3.0/24 [110/3] via 10.2.4.4, 01:25:44, FastEthernet0/1
C        10.2.1.0/24 is directly connected, FastEthernet0/0
L        10.2.1.2/32 is directly connected, FastEthernet0/0
O        10.2.2.0/24 [110/2] via 10.2.1.1, 01:25:39, FastEthernet0/0
O        10.2.3.0/24 [110/65] via 10.2.4.4, 01:25:44, FastEthernet0/1
C        10.2.4.0/24 is directly connected, FastEthernet0/1
L        10.2.4.2/32 is directly connected, FastEthernet0/1
O IA     10.3.1.0/24 [110/3] via 10.2.4.4, 00:05:01, FastEthernet0/1
O IA     10.3.2.0/24 [110/3] via 10.2.4.4, 00:05:01, FastEthernet0/1
O IA     10.3.3.0/24 [110/4] via 10.2.4.4, 00:05:01, FastEthernet0/1
```
<br>
<br>

示例2 - 配置R4不安装10.3.3.0/24到RIB(LSA Type 3)<br>
```
配置前:
R4# show ip route | begin Gateway
Gateway of last resort is not set
...
配置后:
R4(config)# ip prefix-list RIB_FILTER seq 5 deny 10.3.3.0/24
R4(config)# ip prefix-list RIB_FILTER seq 10 permit 0.0.0.0/0 le 32
...
```
总结:<br>
distribute list对LSA Type 1, 只是不将LSDB的该项安装到RIB, 并不影响其在Area间传播. 因为LSA Type 1转化为LSA Type 3在distribute操作之前<br>
distribute list对LSA Type 3, 除了不将LSDB的该项安装到RIB, 并且会中断其在Area间传播. 因为LSA Type 3重新生成LSA Type 3在distribute操作之后
<br>
<br>
...
如图15, 当Area 1与Area 3中间间隔一个Area 2时, 由于ABR不允许Type 3 LSA通过非backbone Are接口进入, 并且ABR必须连接到backbone Area, 所以Area 1和Area 3都没有对方的路由<br>
