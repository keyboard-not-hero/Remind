...
** 如公式, Reference\ Bandwidth默认值为100 Mbps, Interface\ Bandwidth与接口speed一致, 结果为小数时, 取整为1
<br>
...
LSA 1在Inter-area的传播(如图7)<br>
图7<br>
![image_not_found](pic/ospf_LSA_3.jpg)<br>
<br>

LSA 5在Inter-area的传播(如图8)<br>
图8<br>
![image_not_found](pic/ospf_LSA_4.jpg)<br>
<br>

LSA 7在Inter-area的传播(如图9)<br>
图9<br>
