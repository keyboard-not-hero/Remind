...
% \usepackage[UTF8,fontset=ubuntu]{ctex}为另一种使用ctex包的方式。CJK为china/japan/korea，即中日朝语言

% 在CJK中文宏包中，字与字之间空格被省略，可使用~符号生成空格。或者使用usepackage的space可选参数，来保留字与字之间的空格

% 中文字体默认使用宋体，ubuntu提供字体宋体/黑体/楷书，windows提供字体宋体/黑体/楷书/仿宋/隶书/幼圆

% ubuntu下，字体对应文件名称：
% 宋体 - uming，包名fonts-arphic-uming
% 楷书 - ukai，包名fonts-arphic-ukai
% 黑体 - zenhei，包名fonts-wqy-zenhei
% 路径：/usr/share/fonts/truetype/arphic或/usr/share/fonts/truetype/wqy
% 安装黑体：sudo apt-get install fonts-wqy-zenhei
% 刷新字体：fc-cache -fv
% 查看安装的中文字体：fc-list :lang=zh
