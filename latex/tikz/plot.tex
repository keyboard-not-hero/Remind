...
\begin{tikzpicture}
    ...
    %     [2]north east outside - 在右侧，并且顶端与可视表的顶端对齐
    %     [3]south east outside - 在右侧，并且底端与可视表的底端对齐
    %     [4]west outside/left - 在左侧
    %     [5]north west outside - 在左侧，并且顶端与可视表的顶端对齐
    %     [6]south west outside - 在左侧，并且底端与可视表的底端对齐
    %     [7]north outside/above - 在顶侧
    %     [8]south outside/below - 在底侧
    %   2)matrix node style - legend矩阵的属性. 如: fill=black!50
    %   3)down then right - legend的内容，排序方式. 列表如下:
