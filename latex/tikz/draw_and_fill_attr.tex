...
\begin{tikzpicture}
    ...
    \node at (0,0) {$x$};
    \fill[color=red!40!green,opacity=0.5] (-1,-1) rectangle (1,1);
    \node[text opacity=0.2] at (0,-2) {This is transparent text};
\end{tikzpicture}\\\vspace{1cm}
...
\begin{tikzpicture}
    ...
    \draw[double] (0,0) -- (2,0);
    \draw[red,double=green,double distance=3pt] (0,-1) -- (2,-1);
\end{tikzpicture}\\\vspace{1cm}
