...
\begin{tabular}{l l l}
	\hline
	类别 & 字体命令 & 输出效果\\\hline
	斜体 & \verb+\mathit+ & $\mathit{ABCHIJXYZabchijxyz12345}$\\
	...
	手写体(花体)\footnotemark[1] & \verb+\mathcal+ & $\mathcal{ABCHIJXYZ}$\\
	加粗斜体\footnotemark[2] & \verb+\bm+ & $\bm{ABCHIJXYZabchijxyz12345}$\\
	\hline
\end{tabular}
\footnotetext[1]{\LaTeX{}默认只支持大写字母，使用专业字体包可支持小写字母}
\footnotetext[2]{包含在bm宏包中}
\end{minipage}
\caption{数学字体类型}
\end{table}
