...
\begin{tabular}{l l l l l l}
	...
	$\vdash$ & \textbackslash  vdash & $\dashv$ & \textbackslash  dashv & $\Join$ & \textbackslash  Join\footnotemark[3]\\
	$\sqsubset$ & \textbackslash sqsubset\footnotemark[3] & $\sqsupset$ & \textbackslash  sqsupset\footnotemark[3]\\
	\hline
\end{tabular}
\footnotetext[1]{包含在amssymb宏包中}
\footnotetext[2]{包含在txfonts宏包中}
\footnotetext[3]{包含在latexsym宏包中}
