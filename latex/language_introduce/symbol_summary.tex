...
\begin{tabular}{l l l l l l l l}
	...
	\v{o} & \textbackslash v\{o\} & \H{o} & \textbackslash H\{o\} & \t{o} & \textbackslash t\{o\} & \c{o} & \textbackslash c\{o\}\\
	\d{o} & \textbackslash d\{o\} & \b{o} & \textbackslash d\{o\}\\
	\hline
\end{tabular}
\caption{重音符}
\end{table}
...
\begin{tabular}{l l l l l l l l}
	...
	$\oint$ & $\backslash$oint & $\bigcap$ & $\backslash$bigcap & $\bigcup$ & $\backslash$bigcup & $\bigsqcup$ & $\backslash$bigsqcup\\
	$\bigvee$ & $\backslash$bigvee & $\bigwedge$ & $\backslash$bigwedge & $\bigodot$ & $\backslash$bigodot & $\bigoplus$ & $\backslash$bigoplus\\
	$\bigotimes$ & $\backslash$bigotimes & $\biguplus$ & $\backslash$biguplus & $\iint$ & $\backslash$iint & $\iiint$ & $\backslash$iiint\\
