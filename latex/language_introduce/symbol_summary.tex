...
\begin{tabular}{l@{\hspace{5ex}}l@{\hspace{5ex}}l@{\hspace{5ex}}l@{\hspace{5ex}}l@{\hspace{5ex}}l}
    ...
    \hline
\end{tabular}
\footnotetext[99]{可在导言区使用\textbackslash  DeclareMathOperator\{\textbackslash  \textless command\textgreater\}\{\textless str\textgreater\}来定义新数学符号.\\如\textbackslash  DeclareMathOperator\{\textbackslash  sech\}\{sech\}}
\end{minipage}
\caption{不带上下限的数学运算符}
\end{table}
