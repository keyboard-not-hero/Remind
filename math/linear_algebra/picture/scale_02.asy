...
label(y, position=(0,1.5), align=1.5W);


// 拉伸内容
add("hatch", hatch(H=1mm, dir=(1, 0.6)));
filldraw(yscale(1.5)*box((0,0),(1,1)), fillpen=pattern("hatch"));

draw((0.3, 0.3) -- (0.3, 1.2), arrow=EndArcArrow(size=3, filltype=FillDraw(fillpen=white)), p=RGB(100,100,100));

draw((0.7, 0.3) -- (0.7, 1.2), arrow=EndArcArrow(size=3, filltype=FillDraw(fillpen=white)), p=RGB(100,100,100));
