...
label(x, position=(1,0), align=2N+2E);
...
add("hatch_t", hatch(H=1mm, dir=reflect((0,0),(1,0))*(1, 0.6)));
filldraw(reflect((0,0),(1,0))*box((0,0),(1,1)), pattern("hatch_t"));

draw(arc((-1,0), 1.5, 20, -20), arrow=EndArcArrow(size=3, filltype=FillDraw(fillpen=white)), p=RGB(100,100,100));
