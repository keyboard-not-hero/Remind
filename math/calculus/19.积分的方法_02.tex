...
\phantom{$\displaystyle\int\frac{1}{\sec x+1}\dif x$}$\displaystyle=\int\frac{\sec x-1}{\tan^2x}\dif x=\int\frac{\sec x}{\tan^2x}\dif x-\int\frac{1}{\tan^2x}\dif x$\\
...
\phantom{$\displaystyle\therefore\int\sin^6x\dif x$}$\displaystyle=-\frac{1}{48}(1-\cos2x)^2\sin2x-\frac{5}{96}(1-\cos2x)\sin2x+\frac{5}{16}x-\frac{5}{32}\sin2x+C$\\
...
\phantom{$\displaystyle\int\cos^7x\sin^{10}x\dif x$}$\displaystyle=\int(t^{10}-3t^{12}+3t^{14}-t^{16})\dif t$\\
\phantom{$\displaystyle\int\cos^7x\sin^{10}x\dif x$}$\displaystyle=\frac{1}{11}t^{11}-\frac{3}{13}t^{13}+\frac{1}{5}t^{15}-\frac{1}{17}t^{17}+C$\\
将$t=\sin x$代入上式:\\
...
\phantom{$\displaystyle\int\frac{x^2}{(9-x^2)^{\frac{3}{2}}}\dif x$}$\displaystyle\int(\sec^2\theta-1)\dif\theta=\tan\theta-\theta+C$\\
...
\phantom{$\displaystyle\int(x^+15)^{-\frac{5}{2}}\dif x$}$\displaystyle=\frac{1}{225}\int\cos^3\theta\dif\theta$\\
...
\phantom{$\displaystyle\int\frac{1}{x^3\sqrt{x^2-4}}\dif x$}$\displaystyle=\frac{1}{8}\int\cos^2\theta\dif\theta$\\
